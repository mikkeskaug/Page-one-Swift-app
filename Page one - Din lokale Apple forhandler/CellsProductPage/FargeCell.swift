...
protocol FargeCellDelegate: AnyObject {
    func getFarge(_ data: String)
    
}

class FargeCell: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {

    static let identifier = "FargeCell"
    var minne = [String]()
    var selectedItem = String()
    
    weak var delegate: FargeCellDelegate?
    ...
    private let collectionView: UICollectionView = {
        ...
        collectionView.register(FargeCollectionViewCell.self, forCellWithReuseIdentifier: FargeCollectionViewCell.identifier)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: FargeCollectionViewCell.identifier, for: indexPath)
                as? FargeCollectionViewCell else {
                    fatalError()
                }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        print(selectedItem)
        self.delegate?.getFarge(selectedItem)
    }
