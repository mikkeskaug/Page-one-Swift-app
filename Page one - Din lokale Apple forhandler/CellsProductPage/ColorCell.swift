...
//
//  Created by Jon Mikael Skaug on 27/01/2022.
...
class ColorCell: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: ColorCollectionViewCell.identifier, for: indexPath)
                as? ColorCollectionViewCell else {
                    fatalError()
                }
        cell.button.setTitle(finish[indexPath.row], for: .normal)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        selectedItem = self.finish[indexPath.row]
        print("Farge: ", selectedItem)
        self.delegate?.getColor(selectedItem)
    }
